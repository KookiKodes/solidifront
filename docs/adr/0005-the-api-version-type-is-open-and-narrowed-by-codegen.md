...
**The Customer Account API gets none of this.** No direct proxy (verified 404), no tokenless introspection (OAuth-gated), no version enumeration. Its version is therefore pinned by solidifront rather than consumer-configurable — decided by exclusion, mechanism unsolved. See [#34](https://github.com/KookiKodes/solidifront/issues/34).
