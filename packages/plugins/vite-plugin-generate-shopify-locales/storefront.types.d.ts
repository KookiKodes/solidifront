...
export type CartDeliveryOption = {
  ...
  deliveryPromise?: Maybe<Scalars['String']['output']>;
...
export enum CartErrorCode {
  ...
  DeliveryAddressNotEditable = 'DELIVERY_ADDRESS_NOT_EDITABLE',
...
export type CartPaymentInput = {
  ...
  /**
   * The input fields to use when checking out a cart with a Stripe payment method.
   *
   */
  stripeSharedTokenPaymentMethod?: InputMaybe<StripeSharedTokenPaymentMethodInput>;
  /**
...
export type ConsentManagement = {
  ...
  /** Given the provided visitor consent, the resulting ConsentManagementCookies that need to be setin the browser for the Consent Management Platform to work and respect visitor consent. */
  cookies: ConsentManagementCookies;
  /** For debugging purposes, decodes the cookies from `_shopify_essential`, `_shopify_analytics` etc and prints them in plain text. */
  currentCookies: Scalars['String']['output'];
...
export type ConsentManagementCookiesArgs = {
  ...
  origReferrer?: InputMaybe<Scalars['String']['input']>;
...
export type ConsentManagementBanner = {
  ...
  /** Deprecated field. Whether the merchant changed or not any banner field from its default value. */
...
export enum ConsentManagementBannerThemeEnum {
...
export type ConsentManagementCookies = {
  ...
  landingPageCookie?: Maybe<Scalars['String']['output']>;
  /** If needed, the _orig_referrer cookie to set. */
  origReferrerCookie?: Maybe<Scalars['String']['output']>;
  /** The _shopify_analytics cookie to set. */
  shopifyAnalyticsCookie?: Maybe<Scalars['String']['output']>;
  /** The _shopify_essential cookie to set. */
  shopifyEssentialCookie?: Maybe<Scalars['String']['output']>;
...
export type CustomerEmailMarketingSubscribePayload = {
  ...
  /** The created customer object. */
  customer?: Maybe<CustomerMarketingSubscribe>;
  /** The list of errors that occurred from executing the mutation. */
  customerUserErrors: Array<CustomerUserError>;
};
...
export type CustomerMarketingSubscribe = {
  __typename?: 'CustomerMarketingSubscribe';
  /** A unique ID for the customer. */
  id: Scalars['ID']['output'];
};
...
export type CustomerSmsMarketingSubscribePayload = {
  __typename?: 'CustomerSmsMarketingSubscribePayload';
  /** The created customer object. */
  customer?: Maybe<CustomerMarketingSubscribe>;
  /** The list of errors that occurred from executing the mutation. */
  customerUserErrors: Array<CustomerUserError>;
...
export type Filter = {
  ...
  operator?: Maybe<FilterOperatorType>;
  /**
...
/**
 * Specifies the logical operator used for filtering multiple values within a filter.
 * Example:
 * Given the filter is 'color' and values are 'red' and 'blue':
...
export type Mutation = {
  ...
  customerSmsMarketingSubscribe?: Maybe<CustomerSmsMarketingSubscribePayload>;
...
/** The schema’s entry-point for mutations. This acts as the public, top-level API from which all mutation queries must start. */
export type MutationCustomerEmailMarketingSubscribeArgs = {
  email: Scalars['String']['input'];
};
...
/** The schema’s entry-point for mutations. This acts as the public, top-level API from which all mutation queries must start. */
export type MutationCustomerSmsMarketingSubscribeArgs = {
...
/** Shop represents a collection of the general settings and information about the shop. */
export type ShopPrivacyPolicyArgs = {
  sanitized?: InputMaybe<Scalars['Boolean']['input']>;
};


/** Shop represents a collection of the general settings and information about the shop. */
export type ShopRefundPolicyArgs = {
  sanitized?: InputMaybe<Scalars['Boolean']['input']>;
};


/** Shop represents a collection of the general settings and information about the shop. */
export type ShopShippingPolicyArgs = {
  sanitized?: InputMaybe<Scalars['Boolean']['input']>;
};


/** Shop represents a collection of the general settings and information about the shop. */
export type ShopSubscriptionPolicyArgs = {
  sanitized?: InputMaybe<Scalars['Boolean']['input']>;
};


/** Shop represents a collection of the general settings and information about the shop. */
export type ShopTermsOfServiceArgs = {
  sanitized?: InputMaybe<Scalars['Boolean']['input']>;
};
...
/** Represents a sitemap resource that is not a metaobject. */
export type SitemapResourceBase = SitemapResourceInterface & {
  __typename?: 'SitemapResourceBase';
  /** Resource's handle. */
  handle: Scalars['String']['output'];
  /** Resource's image. */
  image?: Maybe<SitemapImage>;
...
export enum SitemapType {
   ...
   */
  MetaobjectPage = 'METAOBJECT_PAGE',
...
/**
 * The input fields to use when checking out a cart with a Stripe shared token.
 *
 */
export type StripeSharedTokenPaymentMethodInput = {
  /** The customer's billing address. */
  billingAddress?: InputMaybe<MailingAddressInput>;
  /** The ID of the Stripe shared token to use for the checkout. */
  stripeSharedTokenId: Scalars['String']['input'];
};
...
export enum SubmissionErrorCode {
  ...
  DeliveryCountryInvalid = 'DELIVERY_COUNTRY_INVALID',
  ...
  /** Country is not supported. */
  PaymentsCountryInvalid = 'PAYMENTS_COUNTRY_INVALID',
...
export type VisitorConsent = {
  ...
  /**
   * Key/value pairs for the metafields.
   *
   * The input must not contain more than `250` values.
   */
  metafields?: InputMaybe<Array<CustomConsent>>;
