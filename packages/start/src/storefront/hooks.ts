...
//   GeneratedMutation extends StorefrontMutations = StorefrontMutations,
// >(mutation: Mutation, revalidateQueries?: string[]) {
...
//     ) => {
//       "use server";
//       const req = await storefront.mutate<Mutation, GeneratedMutation>(
//         mutation,
